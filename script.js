(function () {
  ...
  (function () {
    ...
    if (quoteCountry && quoteTel) setupPhoneCountrySelect(quoteCountry, quoteTel);
    if (contactCountry && contactTel) setupPhoneCountrySelect(contactCountry, contactTel);
  })();
  ...
  window.handleContactSubmit = function (event) {
    ...
    var fullPhone = numberDigits ? '+' + countryCode + numberDigits : '';
